...
pygame.display.set_caption("Copied Game!!!!")
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    red_health_text = HEALTH_FONT.render("Health: "+ str(red_health), 1, BACK)
    yellow_health_text = HEALTH_FONT.render("Health: " + str(yellow_health), 1, BACK)
...
def draw_winner(text):
    draw_text = WINNER_FONT.render(text, 1, BACK)
